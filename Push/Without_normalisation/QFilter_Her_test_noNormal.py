...
import random
import pickle
import TD3_HER_Qfilter_noNormal as TD3
...
while steps < max_steps + 1:
    ...
    if len(replay_buffer) > learning_starts:
        num_accept, num_total = agent.train(replay_buffer, demos, iterations=2)
    ...
    episodes += 1
np.save(f"/home/zhu_y@WMGDS.WMG.WARWICK.AC.UK/PycharmProjects/pythonProject/Results/noNormalisation/{env_name}/StdQfilter/noNoise/Qfilter_S{seed}_score", score_history)
np.save(f"/home/zhu_y@WMGDS.WMG.WARWICK.AC.UK/PycharmProjects/pythonProject/Results/noNormalisation/{env_name}/StdQfilter/noNoise/Qfilter_S{seed}_success", success_history)
np.save(f"/home/zhu_y@WMGDS.WMG.WARWICK.AC.UK/PycharmProjects/pythonProject/Results/noNormalisation/{env_name}/StdQfilter/noNoise/Qfilter_S{seed}_demoaccept",
        average_accept_demos)
np.save(f"/home/zhu_y@WMGDS.WMG.WARWICK.AC.UK/PycharmProjects/pythonProject/Results/noNormalisation/{env_name}/StdQfilter/noNoise/Qfilter_S{seed}_BCL",
