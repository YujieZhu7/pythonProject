...
mcdropout_mean_score4_3 = np.load(f"/home/zhu_y@WMGDS.WMG.WARWICK.AC.UK/PycharmProjects/pythonProject/Results/{env_name}/DropoutQfilter/hidden4/DropoutRate0.03/Mean/0.5+1EnsSize_2_S5_score.npy")
...
mcdropout_first_score4_3 = np.load(f"/home/zhu_y@WMGDS.WMG.WARWICK.AC.UK/PycharmProjects/pythonProject/Results/{env_name}/DropoutQfilter/hidden4/DropoutRate0.03/First/0.5+1EnsSize_2_S5_score.npy")
...
plt.plot(x, mcdropout_first_score2[:8000:40], color='blue', label='First_dropoutrate_0.01')
plt.plot(x, mcdropout_first_score2_3[:8000:40], color='grey', label='First_dropoutrate_0.03')
# plt.plot(x, mcdropout_first_score4[:8000:40], color='grey', label='mcdropout_first_4hidden_0.01')
plt.plot(x, mcdropout_mean_score2[:8000:40], color='red', label='Mean_dropoutrate_0.01')
plt.plot(x, mcdropout_mean_score2_3[:8000:40], color='orange', label='Mean_dropoutrate_0.03')
...
plt.ylabel('Score')
plt.legend()
plt.savefig('/home/zhu_y@WMGDS.WMG.WARWICK.AC.UK/PycharmProjects/pythonProject/Figure/Push/Noise0.5+1/scores_diffdropoutrate.png')
plt.show()
plt.close()
...
mcdropout_mean_score2 = np.load(f"/home/zhu_y@WMGDS.WMG.WARWICK.AC.UK/PycharmProjects/pythonProject/Results/{env_name}/DropoutQfilter/hidden2/DropoutRate0.01/Mean/0.5+1EnsSize_2_S5_score.npy")
mcdropout_first_score2 = np.load(f"/home/zhu_y@WMGDS.WMG.WARWICK.AC.UK/PycharmProjects/pythonProject/Results/{env_name}/DropoutQfilter/hidden2/DropoutRate0.01/First/0.5+1EnsSize_2_S5_score.npy")
mcdropout_lcb_score2 = np.load(f"/home/zhu_y@WMGDS.WMG.WARWICK.AC.UK/PycharmProjects/pythonProject/Results/{env_name}/DropoutQfilter/hidden2/DropoutRate0.01/LCB/0.5+1EnsSize_2_S5_score.npy")
...
mcdropout_lcb_demoAccept2 = np.load(f"/home/zhu_y@WMGDS.WMG.WARWICK.AC.UK/PycharmProjects/pythonProject/Results/{env_name}/DropoutQfilter/hidden2/DropoutRate0.01/LCB/0.5+1EnsSize_2_S5_demoaccept.npy")
...
mcdropout_mean_demoAccept4_3 = np.load(f"/home/zhu_y@WMGDS.WMG.WARWICK.AC.UK/PycharmProjects/pythonProject/Results/{env_name}/DropoutQfilter/hidden4/DropoutRate0.03/Mean/0.5+1EnsSize_2_S5_demoaccept.npy")
mcdropout_first_demoAccept4_3 = np.load(f"/home/zhu_y@WMGDS.WMG.WARWICK.AC.UK/PycharmProjects/pythonProject/Results/{env_name}/DropoutQfilter/hidden4/DropoutRate0.03/First/0.5+1EnsSize_2_S5_demoaccept.npy")

plt.plot(x, Qfilter_demoAccept[:8000:40], color='purple', label='Qfilter')
plt.plot(x, mcdropout_first_demoAccept2[:8000:40], color='blue', label='First_dropoutrate_0.01')
plt.plot(x, mcdropout_first_demoAccept2_3[:8000:40], color='grey', label='First_dropoutrate_0.03')
# plt.plot(x, mcdropout_first_demoAccept4[:8000:40], color='grey', label='mcdropout_first_4hidden_0.01')
plt.plot(x, mcdropout_mean_demoAccept2[:8000:40], color='red', label='Mean_dropoutrate_0.01')
plt.plot(x, mcdropout_mean_demoAccept2_3[:8000:40], color='orange', label='Mean_dropoutrate_0.03')
# plt.plot(x, mcdropout_mean_demoAccept4[:8000:40], color='orange', label='mcdropout_mean_4hidden_0.01')
# plt.plot(x, mcdropout_first_demoAccept4_3[:8000:40], color='blue', label='mcdropout_first_4hidden_0.03')
# plt.plot(x, mcdropout_mean_demoAccept4_3[:8000:40], color='red', label='mcdropout_mean_4hidden_0.03')
