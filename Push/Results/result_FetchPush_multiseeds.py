...
plt.ylabel('Score')
plt.legend()
# plt.savefig('/home/zhu_y@WMGDS.WMG.WARWICK.AC.UK/PycharmProjects/pythonProject/Figure/Push/Noise0.5+1/Multiseeds/scores_BC_multiseeds.png')
plt.show()
plt.close()

demoAccept_Qfilter_s1 = np.load(f"/home/zhu_y@WMGDS.WMG.WARWICK.AC.UK/PycharmProjects/pythonProject/Results/{env_name}/StdQfilter/RandGausNoise/0.5+1Qfilter_S1_demoaccept.npy")
demoAccept_Qfilter_s2 = np.load(f"/home/zhu_y@WMGDS.WMG.WARWICK.AC.UK/PycharmProjects/pythonProject/Results/{env_name}/StdQfilter/RandGausNoise/0.5+1Qfilter_S2_demoaccept.npy")
demoAccept_Qfilter_s3 = np.load(f"/home/zhu_y@WMGDS.WMG.WARWICK.AC.UK/PycharmProjects/pythonProject/Results/{env_name}/StdQfilter/RandGausNoise/0.5+1Qfilter_S3_demoaccept.npy")
demoAccept_Qfilter_s4 = np.load(f"/home/zhu_y@WMGDS.WMG.WARWICK.AC.UK/PycharmProjects/pythonProject/Results/{env_name}/StdQfilter/RandGausNoise/0.5+1Qfilter_S4_demoaccept.npy")
demoAccept_Qfilter_s5 = np.load(f"/home/zhu_y@WMGDS.WMG.WARWICK.AC.UK/PycharmProjects/pythonProject/Results/{env_name}/StdQfilter/RandGausNoise/0.5+1Qfilter_S5_demoaccept.npy")
demoAccept_Qfilter_mean = (demoAccept_Qfilter_s1+demoAccept_Qfilter_s2+demoAccept_Qfilter_s3+demoAccept_Qfilter_s4+demoAccept_Qfilter_s5)/5
...
plt.plot(x, demoAccept_first_s1[1::20], color='purple', alpha=0.2)
plt.plot(x, demoAccept_first_s2[1::20], color='purple', alpha=0.2)
plt.plot(x, demoAccept_first_s3[1::20], color='purple', alpha=0.2)
plt.plot(x, demoAccept_first_s4[1::20], color='purple', alpha=0.2)
plt.plot(x, demoAccept_first_s5[1::20], color='purple', alpha=0.2)
...
plt.plot(x, demoAccept_Qfilter_mean[1::20], color='purple', label='Qfilter')
plt.plot(x, demoAccept_first_mean[1::20], color='blue', label='First')
...
plt.legend()
plt.savefig('/home/zhu_y@WMGDS.WMG.WARWICK.AC.UK/PycharmProjects/pythonProject/Figure/Push/Noise0.5+1/Multiseeds/demoaccept_multiseeds.png')
plt.show()
plt.close()
...
plt.plot(x, score_first_mean[1::20], color='blue', label='First')
...
plt.ylabel('Score')
plt.legend()
plt.savefig('/home/zhu_y@WMGDS.WMG.WARWICK.AC.UK/PycharmProjects/pythonProject/Figure/Push/Noise0.5+1/Multiseeds/scores_multiseeds.png')
plt.show()
plt.close()
...
plt.plot(x, success_first_mean[1::20], color='blue', label='First')
...
plt.legend()
plt.savefig('/home/zhu_y@WMGDS.WMG.WARWICK.AC.UK/PycharmProjects/pythonProject/Figure/Push/Noise0.5+1/Multiseeds/success_multiseeds.png')
plt.show()
plt.close()
