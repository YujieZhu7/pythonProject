...
import TD3_HER_pretrainQ as Pretrain
...
agent = Pretrain.Agent(state_dim, goal_dim, action_dim, max_action, hidden_dim=(256,256),
...
torch.save(agent.critic_target.state_dict(),
                                   f"/home/zhu_y@WMGDS.WMG.WARWICK.AC.UK/PycharmProjects/pythonProject/SaveModels/{env_name}/PretrainExpert/TD3_pretrain_critictarget_steps1e4")
