...
agent = TD3.Agent(state_dim, goal_dim, action_dim, max_action, hidden_dim=(256, 256),
                  drop_rate=drop_rate, method=method, lmbda1=0.001,
...
while steps < max_steps + 1:
    ...
    episodes += 1
np.save(f"/home/zhu_y@WMGDS.WMG.WARWICK.AC.UK/PycharmProjects/pythonProject/Results/{env_name}/DropoutQfilter/hidden2/DropoutRate0.03/{method}/0.5+1_S{seed}_score", score_history)
np.save(f"/home/zhu_y@WMGDS.WMG.WARWICK.AC.UK/PycharmProjects/pythonProject/Results/{env_name}/DropoutQfilter/hidden2/DropoutRate0.03/{method}/0.5+1_S{seed}_success", success_history)
np.save(f"/home/zhu_y@WMGDS.WMG.WARWICK.AC.UK/PycharmProjects/pythonProject/Results/{env_name}/DropoutQfilter/hidden2/DropoutRate0.03/{method}/0.5+1_S{seed}_demoaccept",
        average_accept_demos)
np.save(f"/home/zhu_y@WMGDS.WMG.WARWICK.AC.UK/PycharmProjects/pythonProject/Results/{env_name}/DropoutQfilter/hidden2/DropoutRate0.03/{method}/0.5+1_S{seed}_BCL",
