...
import random
import pickle
import TD3_HER_Qfilter_ensemble_save as TD3
...
while steps < max_steps + 1:
    ...
    if len(replay_buffer) > learning_starts:
        ...
        goal_stats = finalize(goals_agg)
        num_accept, num_total, demos_Q_std1, Q_dem_std1, demos_Q1, Q_dem1 = agent.train(replay_buffer, demos,
        ...
        policy_Qstd.append(demos_Q_std1)
        demos_Qstd.append(Q_dem_std1)
        policy_Qmean.append(demos_Q1)
        demos_Qmean.append(Q_dem1)
    ...
    if episodes % eps_eval == 0:
        ...
        if len(percent_accept_demos) == 0:
            ...
            # print("Difference of Q %.2f" % Q_diff_list[-1])
...
#         average_accept_demos)
# np.save(f"/home/zhu_y@WMGDS.WMG.WARWICK.AC.UK/PycharmProjects/pythonProject/Results/{env_name}/EnsQfilter/RandGausNoise/{method}/EnsSize_{ensemble_size}_S{seed}_Qdiff",
#         Q_diff_list)
...
np.save(f"/home/zhu_y@WMGDS.WMG.WARWICK.AC.UK/PycharmProjects/pythonProject/Results/{env_name}/EnsQfilter/RandGausNoise/{method}/EnsSize_{ensemble_size}_S{seed}_demosQstd",
        demos_Qstd)
np.save(f"/home/zhu_y@WMGDS.WMG.WARWICK.AC.UK/PycharmProjects/pythonProject/Results/{env_name}/EnsQfilter/RandGausNoise/{method}/EnsSize_{ensemble_size}_S{seed}_policyQmean",
        policy_Qmean)
np.save(f"/home/zhu_y@WMGDS.WMG.WARWICK.AC.UK/PycharmProjects/pythonProject/Results/{env_name}/EnsQfilter/RandGausNoise/{method}/EnsSize_{ensemble_size}_S{seed}_demosQmean",
        demos_Qmean)