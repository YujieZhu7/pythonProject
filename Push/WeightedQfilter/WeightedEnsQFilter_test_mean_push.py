...
import random
import pickle
import TD3_HER_Qfilter_weightedBC as TD3
...
while steps < max_steps + 1:
    ...
    episodes += 1
np.save(f"/home/zhu_y@WMGDS.WMG.WARWICK.AC.UK/PycharmProjects/pythonProject/Results/{env_name}/WeightedEnsQfilter/RandGausNoise/{method}/EnsSize_{ensemble_size}_S{seed}_score", score_history)
np.save(f"/home/zhu_y@WMGDS.WMG.WARWICK.AC.UK/PycharmProjects/pythonProject/Results/{env_name}/WeightedEnsQfilter/RandGausNoise/{method}/EnsSize_{ensemble_size}_S{seed}_success", success_history)
np.save(f"/home/zhu_y@WMGDS.WMG.WARWICK.AC.UK/PycharmProjects/pythonProject/Results/{env_name}/WeightedEnsQfilter/RandGausNoise/{method}/EnsSize_{ensemble_size}_S{seed}_demoaccept",
        average_accept_demos)
np.save(f"/home/zhu_y@WMGDS.WMG.WARWICK.AC.UK/PycharmProjects/pythonProject/Results/{env_name}/WeightedEnsQfilter/RandGausNoise/{method}/EnsSize_{ensemble_size}_S{seed}_BCL",
        agent.BC_loss_history)
np.save(f"/home/zhu_y@WMGDS.WMG.WARWICK.AC.UK/PycharmProjects/pythonProject/Results/{env_name}/WeightedEnsQfilter/RandGausNoise/{method}/EnsSize_{ensemble_size}_S{seed}_totalBCL",
