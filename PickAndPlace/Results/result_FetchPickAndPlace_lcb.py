...
lcb_score_s1_5 = np.load(
    f"/home/zhu_y@WMGDS.WMG.WARWICK.AC.UK/PycharmProjects/pythonProject/Results/{env_name}/EnsQfilter/RanNoise0.1/LCB0.5/EnsSize_10_S1_score.npy")
...
plt.plot(x, first_score_s1[:10000:50], color='blue', alpha=0.2, label='First')
...
plt.plot(x, lcb_score_s1[:10000:50], color='green', alpha=0.2, label='LCB')
...
plt.plot(x, mean_score_s1[:10000:50], color='red', alpha=0.2, label='Mean')
...
plt.plot(x, lcb_score_s1_5[:10000:50], color='black', label='LCB0.5')

plt.title('Scores')
plt.xlabel('Environment interactions')
plt.ylabel('Score')
plt.legend()
plt.savefig('/home/zhu_y@WMGDS.WMG.WARWICK.AC.UK/PycharmProjects/pythonProject/Figure/PickAndPlace/RanNoise0.1/scores_lcb0.5.png')
plt.show()
plt.close()
...
lcb_demoaccept_s1_5 = np.load(
    f"/home/zhu_y@WMGDS.WMG.WARWICK.AC.UK/PycharmProjects/pythonProject/Results/{env_name}/EnsQfilter/RanNoise0.1/LCB0.5/EnsSize_10_S1_demoaccept.npy")
...
plt.plot(x, first_demoaccept_s1[:10000:50], color='blue', alpha=0.2, label='First')
...
plt.plot(x, mean_demoaccept_s1[:10000:50], color='red', alpha=0.2, label='Mean')
...
plt.plot(x, lcb_demoaccept_s1[:10000:50], color='green', alpha=0.2, label='LCB')
...
plt.plot(x, lcb_demoaccept_s1_5[:10000:50], color='black', label='LCB0.5')

plt.title('Accpetance Rate of demonstrations')
plt.xlabel('Environment interactions')
plt.ylabel('Accpetance Rate')
plt.legend()
plt.savefig('/home/zhu_y@WMGDS.WMG.WARWICK.AC.UK/PycharmProjects/pythonProject/Figure/PickAndPlace/RanNoise0.1/demoaccepts_lcb0.5.png')
plt.show()
plt.close()