...
BC_only_score_mean = (BC_only_score_s1 + BC_only_score_s2 + BC_only_score_s3) / 3
...
Qfilter_mean = (Qfilter_s1 + Qfilter_s2 + Qfilter_s3) / 3
...
Qfilter_score_ensemble_mean = (
                                          Qfilter_score_ensemble_s1 + Qfilter_score_ensemble_s2 + Qfilter_score_ensemble_s3) / 3
...
plt.ylabel('Score')
plt.legend()
plt.savefig('/home/zhu_y@WMGDS.WMG.WARWICK.AC.UK/PycharmProjects/pythonProject/Figure/PickAndPlace/RanNoise0.1/scores_BC.png')
plt.show()
plt.close()
...
first_score_s3 = np.load(
    f"/home/zhu_y@WMGDS.WMG.WARWICK.AC.UK/PycharmProjects/pythonProject/Results/{env_name}/EnsQfilter/RanNoise0.1/First/EnsSize_10_S3_score.npy")
first_score_mean = (first_score_s1 + first_score_s2 + first_score_s3) / 3
...
# lcb_score_mean = (lcb_score_s1+lcb_score_s2+lcb_score_s3)/3
...
lcb5_score_s4 = np.load(
    f"/home/zhu_y@WMGDS.WMG.WARWICK.AC.UK/PycharmProjects/pythonProject/Results/{env_name}/EnsQfilter/RanNoise0.1/LCB0.5/EnsSize_10_S4_score.npy")
lcb5_score_s5 = np.load(
    f"/home/zhu_y@WMGDS.WMG.WARWICK.AC.UK/PycharmProjects/pythonProject/Results/{env_name}/EnsQfilter/RanNoise0.1/LCB0.5/EnsSize_10_S5_score.npy")
lcb5_score_mean = (lcb5_score_s4+lcb5_score_s5)/2
...
# mean_score_mean = (mean_score_s1 + mean_score_s2 + mean_score_s3) / 3
...
plt.plot(x, lcb5_score_s4[:10000:50], color='grey', alpha=0.2)
plt.plot(x, lcb5_score_s5[:10000:50], color='grey', alpha=0.2)
...
plt.ylabel('Score')
plt.legend()
plt.savefig('/home/zhu_y@WMGDS.WMG.WARWICK.AC.UK/PycharmProjects/pythonProject/Figure/PickAndPlace/RanNoise0.1/scores_multiseeds.png')
plt.show()
plt.close()
#
...
first_demoaccept_mean = (first_demoaccept_s1+first_demoaccept_s2+first_demoaccept_s3)/3
...
# mean_demoaccept_mean = (mean_demoaccept_s1+mean_demoaccept_s2+mean_demoaccept_s3)/3
...
# lcb_demoaccept_mean =(lcb_demoaccept_s1+lcb_demoaccept_s2+lcb_demoaccept_s3)/3
...
lcb5_demoaccept_s4 = np.load(
    f"/home/zhu_y@WMGDS.WMG.WARWICK.AC.UK/PycharmProjects/pythonProject/Results/{env_name}/EnsQfilter/RanNoise0.1/LCB0.5/EnsSize_10_S4_demoaccept.npy")
lcb5_demoaccept_s5 = np.load(
    f"/home/zhu_y@WMGDS.WMG.WARWICK.AC.UK/PycharmProjects/pythonProject/Results/{env_name}/EnsQfilter/RanNoise0.1/LCB0.5/EnsSize_10_S5_demoaccept.npy")
lcb5_demoaccept_mean =(lcb5_demoaccept_s4+lcb5_demoaccept_s5)/2
...
plt.plot(x, lcb5_demoaccept_s4[:10000:50], color='grey', alpha=0.2)
plt.plot(x, lcb5_demoaccept_s5[:10000:50], color='grey', alpha=0.2)

# plt.plot(x, min_demoaccept_s1[:10000:50], color='orange', label='Min')
plt.plot(x, first_demoaccept_mean[:10000:50], color='blue', label='First')
plt.plot(x, lcb_demoaccept_mean[:10000:50], color='green', label='LCB')
plt.plot(x, mean_demoaccept_mean[:10000:50], color='red', label='Mean')
plt.plot(x, lcb5_demoaccept_mean[:10000:50], color='grey', label='LCB0.5')

plt.title('Accpetance Rate of demonstrations')
plt.xlabel('Environment interactions')
plt.ylabel('Accpetance Rate')
plt.legend()
plt.savefig('/home/zhu_y@WMGDS.WMG.WARWICK.AC.UK/PycharmProjects/pythonProject/Figure/PickAndPlace/RanNoise0.1/demoaccepts_multiseeds.png')
plt.show()
plt.close()
...
plt.plot(x, lcb_BCL_s5[:10000:500], color='green', label='LCB')
plt.plot(x, mean_BCL_s5[:10000:500], color='red', label='Mean')
plt.title('BC Loss')
plt.xlabel('Environment interactions')
plt.ylabel('BC Loss')
plt.legend()
plt.savefig('/home/zhu_y@WMGDS.WMG.WARWICK.AC.UK/PycharmProjects/pythonProject/Figure/PickAndPlace/RanNoise0.1/BCL_meanvslcb.png')
plt.show()
plt.close()