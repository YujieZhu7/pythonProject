...
from Qfilter_HER.Algo import TD3_HER_weightedBC_only as TD3
...
np.save(f"/home/zhu_y@WMGDS.WMG.WARWICK.AC.UK/PycharmProjects/pythonProject/Results/{env_name}/weightedBC_only/RanNoise0.1/BC_S{seed}_score", score_history)
np.save(f"/home/zhu_y@WMGDS.WMG.WARWICK.AC.UK/PycharmProjects/pythonProject/Results/{env_name}/weightedBC_only/RanNoise0.1/BC_S{seed}_sucess", success_history)
np.save(f"/home/zhu_y@WMGDS.WMG.WARWICK.AC.UK/PycharmProjects/pythonProject/Results/{env_name}/weightedBC_only/RanNoise0.1/BC_S{seed}_BCL", agent.BC_loss_history)
