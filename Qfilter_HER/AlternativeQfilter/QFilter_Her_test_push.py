...
while steps < max_steps + 1:
    ...
    episodes += 1
np.save(f"/home/zhu_y@WMGDS.WMG.WARWICK.AC.UK/PycharmProjects/pythonProject/Results/{env_name}/AltStdQfilter/RanNoise0.1/Qfilter_S{seed}_score", score_history)
np.save(f"/home/zhu_y@WMGDS.WMG.WARWICK.AC.UK/PycharmProjects/pythonProject/Results/{env_name}/AltStdQfilter/RanNoise0.1/Qfilter_S{seed}_success", success_history)
np.save(f"/home/zhu_y@WMGDS.WMG.WARWICK.AC.UK/PycharmProjects/pythonProject/Results/{env_name}/AltStdQfilter/RanNoise0.1/Qfilter_S{seed}_demoaccept",
        average_accept_demos)
